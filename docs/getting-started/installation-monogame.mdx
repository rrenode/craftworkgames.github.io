...
<Tabs>
  <TabItem value="window" label="Windows" default>
    ```
    %USERPROFILE%\.nuget\packages\monogame.extended.content.pipeline\3.9.0-prerelease.4\tools\MonoGame.Extended.Content.Pipeline.dll
    ```
  </TabItem>
  <TabItem value="mac" label="macOS">
    ```sh
    ~/.nuget/packages/monogame.extended.content.pipeline/3.9.0-prerelease.4/tools/MonoGame.Extended.Content.Pipeline.dll
    ```
  </TabItem>
